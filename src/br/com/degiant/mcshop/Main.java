...
public class Main extends JavaPlugin implements Listener {
  ...
  public void reloadConfig() {
    ...
    String user = this.getConfig().getString("sql.user", "root"),
        pass = this.getConfig().getString("sql.pass", ""),
        serv = this.getConfig().getString("sql.serv", "localhost"),
        base = this.getConfig().getString("sql.base", "base");
  ...
  public static void initCommand(final Command command) {
    try {
      final Field field = Class.forName("org.bukkit.craftbukkit." + getVersion() + ".CraftServer")
